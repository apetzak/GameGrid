...
namespace GameGrid
{
    ...
    /// 
    /// </summary>
    public class GameFaqs : WebSource
    {
        ...
        {
            return Node("//*[@class='page-title']").InnerText;
        }

        public static string GetSystem()
        {
            return Node("//*[@class='platform-title']").InnerText;
        }

        public static string GetDescription()
        {
            return Node("//*[@class='desc']").InnerText;
        }

        public static void SetDetails(Game g)
        {
            var node = Node("//*[@class='pod pod_gameinfo']");
        ...
        {
            var nodes = Nodes("//*[@class='subsection-title']");
        ...
        {
            var node = Node("//*[@class='content_nav content_nav_split']");
